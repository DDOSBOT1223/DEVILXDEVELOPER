...
TOKEN = ''7837130437:AAFoD7W9q3yAs9zQBrHN8VYRVPlAziurwZE
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 ACCESS DENIED!*\n"  # Access Denied message
                                       ...
                                       "*DM OWNER :- @DEVILVIPDDOS.*", parse_mode='Markdown')  # Contact owner message
            return
...
def owner_command(message):
    response = ("* DM OWNNER :- @DEVILVIPDDOS*")
    bot.send_message(message.chat.id, response, parse_mode='Markdown')

@bot.message_handler(commands=['start'])
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*😈 WELCOME TO DEVIL DDOS*😈\n"
                                           "LET'S FUCK THE GAME*\n"
